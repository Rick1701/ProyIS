...
//MODIFICAR SOLO MONTOS (SOLO LO HARA EL ENCARGADO)
const modificarSoloMontoGastoComun = (req, res) => {
    const { id } = req.params;
...
//MÉTODO PARA PAGAR UNA DEUDA (PROPIETARIO)
